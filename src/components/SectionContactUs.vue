                    ...
                    <div class="card-body">
                      ...
                      <ValidationObserver ref="contactUsForm" tag="div">
                        <form id="contact-us-form" method="post" v-on:submit.prevent="submitForm($event)">
                          ...
                          <div class="form-row">
                            <ValidationProvider class="col-md-6 form-group" rules="required|email" name="email address" v-slot="{ valid, errors }" tag="div">
                              <label class="sr-only" for="email">Email</label>
                              <input type="email" class="form-control" id="email" name="email" v-model="email" v-bind:class="{ 'is-invalid': errors[0] }" placeholder="Enter Email Address">
                              <div class="invalid-feedback">{{ errors[0] }}</div>
                            </ValidationProvider>
                            <ValidationProvider class="col-md-6 form-group" rules="required" name="phone number" v-slot="{ valid, errors }" tag="div">
                              <label class="sr-only" for="email">Phone</label>
                              <input type="text" class="form-control" id="phone" name="phone" v-model="phone" v-bind:class="{ 'is-invalid': errors[0] }" placeholder="Enter Phone Number">
                              <div class="invalid-feedback">{{ errors[0] }}</div>
                            </ValidationProvider>
                          </div>
                          <ValidationProvider class="form-group" rules="required" name="message" v-slot="{ valid, errors }" tag="div">
                            <label class="sr-only" for="message">Message</label>
                            <textarea name="message" id="message" class="form-control" rows="6" cols="120" v-model="message" v-bind:class="{ 'is-invalid': errors[0] }" placeholder="Enter Message"></textarea>
                            <div class="invalid-feedback">{{ errors[0] }}</div>
                          </ValidationProvider>
                          <vue-recaptcha
                            ref="recaptcha"
                          ...
                          <div>
                            <button type="submit" class="btn btn-primary btn-block" :disabled="isLoading" v-cloak>
